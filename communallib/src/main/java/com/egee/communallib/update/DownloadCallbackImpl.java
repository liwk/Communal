...
public class DownloadCallbackImpl implements DownloadCallback {
    ...
    public void onDownloadStart() {
        // 下载更新包开始
        ToastUtil.showToast(ContextUtils.getContext(), "开始下载新版本");
    }
    ...
    public void onDownloadComplete(File file) {
        // 下载更新包完成
        ToastUtil.showToast(ContextUtils.getContext(), "新版本下载完成");
    }

    @Override
    public void onDownloadError(Throwable t) {
        // 下载更新包出错
        ToastUtil.showToast(ContextUtils.getContext(), "新版本下载失败");
    }
